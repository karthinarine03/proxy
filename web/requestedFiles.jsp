                        ...
                        <div class="col-lg-12 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
                            ...
                            <table id="customers">
                                ...
                                <%
                                    ...
                                    try {
                                        ResultSet rs = st.executeQuery("Select * from request where doid  ='" + doid + "' ");
                                        while (rs.next()) {
                                %>
                                <tr>
                                    ...
                                    <td><%=rs.getString("dostatus")%></td>
                                    <td><a href="approveRequest.jsp?fid=<%=rs.getString("id")%>" class="btn btn-success">Approve</a></td>
                                    <td><a href="rejectRequest.jsp?fid=<%=rs.getString("id")%>" class="btn btn-danger">Reject</a></td>
                                </tr>
                                <%                                        }
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
