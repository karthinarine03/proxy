                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-6 mt-5 mt-lg-0">
                            <img src="assets/img/dologin.png" width="450" height="400" />
                        </div>
                        <div class="col-lg-6 mt-5 mt-lg-0">
                            <form action="doSignin.jsp" method="post" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="doSignup.jsp" class="btn btn-primary btn-lg">Register!</a>
                                </div>
                            </form>
                        </div>
                    </div>
