                ...
                <div class="container" data-aos="fade-up">
                    <div class="row">
                        <div class="col-lg-12 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
                            <center><h3>Data Users Details</h3></center><br>
                            <table id="customers">
                                    <tr>
                                        <th>User ID</th>
                                        <th>Name</th>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="duApprove.jsp?id=<%=rs.getString("id")%>" class="btn btn-success btn-lg">Approve</a></td>
                                    </tr>
                                    <%                                                                                  }
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
